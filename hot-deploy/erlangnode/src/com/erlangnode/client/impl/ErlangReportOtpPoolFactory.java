...
public class ErlangReportOtpPoolFactory extends BasePoolableObjectFactory {
	private static final Log loger = LogFactory.getLog(ErlangOtpPoolFactory.class);
	
	private static final String NODE_NAME = "ReportNodeName";
	private static final String COOKIE = "Cookie";
	public static final String PEER_NODE = "PeerReportNode";
