...
echo on
"%JAVA_HOME%/bin/java" -Xms512M -Xmx512M -Xss64k -XX:PermSize=256m -XX:MaxPermSize=1024m -jar ofbiz.jar
echo off
rem ### If you would prefer the console output to be logged rather than displayed switch out the above line for this one
rem "%JAVA_HOME%/bin/java" -Xms128M -Xmx512M -XX:MaxPermSize=1024m -jar ofbiz.jar > runtime\logs\console.log
