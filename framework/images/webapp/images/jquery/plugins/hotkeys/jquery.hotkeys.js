...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>jquery.hotkeys.js at master from jeresig's jquery.hotkeys - GitHub</title>
...
<script src="http://assets1.github.com/javascripts/bundle_github.js?d30a9dc8a647b7430b9daecd67a285ec9f72ab63" type="text/javascript"></script>
  ...
  <link href="http://github.com/jeresig/jquery.hotkeys/commits/master.atom" rel="alternate" title="Recent Commits to jquery.hotkeys:master" type="application/atom+xml" />

        <meta name="description" content="jQuery Hotkeys lets you watch for keyboard events anywhere in your code supporting almost any key combination." />
    <script type="text/javascript">
      GitHub.nameWithOwner = GitHub.nameWithOwner || "jeresig/jquery.hotkeys";
  ...
  <body>
    ...
    <div class="site">
      <div class="pagehead repohead vis-public fork  ">
        <h1>
          <a href="/jeresig">jeresig</a> / <strong><a href="http://github.com/jeresig/jquery.hotkeys">jquery.hotkeys</a></strong>
    ...
    <ul class="actions">
        ...
        <li class="for-owner" style="display:none"><a href="https://github.com/jeresig/jquery.hotkeys/edit" class="minibutton btn-admin "><span><span class="icon"></span>Admin</span></a></li>
        <li>
          <a href="/jeresig/jquery.hotkeys/toggle_watch" class="minibutton btn-watch " id="watch_button" style="display:none"><span><span class="icon"></span>Watch</span></a>
          <a href="/jeresig/jquery.hotkeys/toggle_watch" class="minibutton btn-watch " id="unwatch_button" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
        </li>
        
          
            <li class="for-notforked" style="display:none"><a href="/jeresig/jquery.hotkeys/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '5d6e6177ae78690e65ef6625854cbe1147b24296'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
            <li class="for-hasfork" style="display:none"><a href="#" class="minibutton btn-fork " id="your_fork_button"><span><span class="icon"></span>Your Fork</span></a></li>
          

          
          <li id="pull_request_item" class='ospr' style="display:none"><a href="/jeresig/jquery.hotkeys/pull_request/" class="minibutton btn-pull-request "><span><span class="icon"></span>Pull Request</span></a></li>
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers"><a href="/jeresig/jquery.hotkeys/watchers" title="Watchers" class="tooltipped downwards">161</a></li>
          <li class="forks"><a href="/jeresig/jquery.hotkeys/network" title="Forks" class="tooltipped downwards">10</a></li>
        </ul>
      </li>
    </ul>
  ...
  <ul class="tabs">
    <li><a href="http://github.com/jeresig/jquery.hotkeys/tree/master" class="selected" highlight="repo_source">Source</a></li>
    <li><a href="http://github.com/jeresig/jquery.hotkeys/commits/master" highlight="repo_commits">Commits</a></li>

    
    <li><a href="/jeresig/jquery.hotkeys/network" highlight="repo_network">Network (10)</a></li>
      ...
      <li><a href="/jeresig/jquery.hotkeys/downloads">Downloads (0)</a></li>
    

    
      
      <li><a href="http://wiki.github.com/jeresig/jquery.hotkeys/">Wiki (1)</a></li>
    

    <li><a href="/jeresig/jquery.hotkeys/graphs" highlight="repo_graphs">Graphs</a></li>
  ...
  <ul>
    ...
    <a href="/jeresig/jquery.hotkeys/branches" class="manage">Branch List</a>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description" rel="repository_description_edit">
          ...
          <p>jQuery Hotkeys lets you watch for keyboard events anywhere in your code supporting almost any key combination.
            <span id="read_more" style="display:none">&mdash; <a href="#readme">Read more</a></span>
          </p>
        
      </div>
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/jeresig/jquery.hotkeys/edit/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="5d6e6177ae78690e65ef6625854cbe1147b24296" /></div>
          <input type="hidden" name="field" value="repository_description">
          <input type="text" class="textfield" name="value" value="jQuery Hotkeys lets you watch for keyboard events anywhere in your code supporting almost any key combination.">
      ...
      <div id="url_box" class="url-box">
        <ul class="clone-urls">
            ...
            <li id="http_clone_url"><a href="http://github.com/jeresig/jquery.hotkeys.git" data-permissions="Read-Only">HTTP</a></li>
            <li id="public_clone_url"><a href="git://github.com/jeresig/jquery.hotkeys.git" data-permissions="Read-Only">Git Read-Only</a></li>
...
<script type="text/javascript">
  ...
  GitHub.currentRepoOwner = "jeresig"
  GitHub.currentRepo = "jquery.hotkeys"
  GitHub.downloadRepo = '/jeresig/jquery.hotkeys/archives/master'
  ...
  <div class="envelope commit">
    <div class="human">
        ...
        <div class="message"><pre><a href="/jeresig/jquery.hotkeys/commit/0451de18d57d3401bd4cc021facbe5fd63b5aae6">jQuery Hotkeys rewritten to work with jQuery 1.4.2. A bunch of old code stripped 
and bugs fixed.</a> <a href="/jeresig/jquery.hotkeys/commit/0451de18d57d3401bd4cc021facbe5fd63b5aae6#comments"><img alt="Comment" src="http://assets1.github.com/images/modules/dashboard/news/comment.png?53081acd2dd130cebd1da08f5aa8f7897bb3ae9e" /></a></pre></div>
      

      <div class="actor">
        <div class="gravatar">
          
          <img src="http://www.gravatar.com/avatar/b3e04a46e85ad3e165d66f5d927eb609?s=140&d=http%3A%2F%2Fgithub.com%2Fimages%2Fgravatars%2Fgravatar-140.png" alt="" width="30" height="30"  />
        </div>
        <div class="name"><a href="/jeresig">jeresig</a> <span>(author)</span></div>
        <div class="date">
          <abbr class="relatize" title="2010-02-22 23:07:02">Mon Feb 22 23:07:02 -0800 2010</abbr>
        </div>
      </div>
    ...
    <div class="machine">
      <span>c</span>ommit&nbsp;&nbsp;<a href="/jeresig/jquery.hotkeys/commit/0451de18d57d3401bd4cc021facbe5fd63b5aae6" hotkey="c">0451de18d57d3401bd4c</a><br />
      <span>t</span>ree&nbsp;&nbsp;&nbsp;&nbsp;<a href="/jeresig/jquery.hotkeys/tree/0451de18d57d3401bd4cc021facbe5fd63b5aae6" hotkey="t">f87549595da3ec491352</a><br />
      
        <span>p</span>arent&nbsp;
        
        <a href="/jeresig/jquery.hotkeys/tree/0042fad94c8656248dfa9c9765330cfede8a085e" hotkey="p">0042fad94c8656248dfa</a>
    ...
    <div id="path">
      <b><a href="/jeresig/jquery.hotkeys/tree/master">jquery.hotkeys</a></b> / jquery.hotkeys.js       <span style="display:none" id="clippy_3479">jquery.hotkeys.js</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_3479&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="http://assets0.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_3479&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
      ...
      <div class="file">
        <div class="meta">
          ...
          <ul class="actions">
              ...
              <li><a id="file-edit-link" href="#" rel="/jeresig/jquery.hotkeys/file-edit/__ref__/jquery.hotkeys.js">edit</a></li>
            
            <li><a href="/jeresig/jquery.hotkeys/raw/master/jquery.hotkeys.js" id="raw-url">raw</a></li>
            
              <li><a href="/jeresig/jquery.hotkeys/blame/master/jquery.hotkeys.js">blame</a></li>
            
            <li><a href="/jeresig/jquery.hotkeys/commits/master/jquery.hotkeys.js">history</a></li>
          </ul>
        </div>
...
<span id="LID99" rel="#L99">99</span>
      ...
      <div class="site">
        <div class="info">
          ...
          <div class="company">
            &copy;
            2010
            <span id="_rrt" title="0.05337s from fe4.rs.github.com">GitHub</span> Inc.
            All rights reserved. |
    ...
    <script>window._auth_token = "5d6e6177ae78690e65ef6625854cbe1147b24296"</script>
